...
@app.route('/about-video/<int:video_id>')
def serve_about_video(video_id):
    """Serve About tab videos with multi-path fallback."""
    # Per-slide preferred filenames, then shared fallbacks
    per_slide = {
        0: ['about-main.mp4', '1.mp4', '2.mp4', '3.mp4', '4.mp4'],
        1: ['2.mp4', 'about-main.mp4', '1.mp4', '3.mp4', '4.mp4'],
        2: ['1.mp4', 'about-main.mp4', '2.mp4', '3.mp4', '4.mp4'],
    }
    candidates = per_slide.get(video_id, ['about-main.mp4', '1.mp4', '2.mp4', '3.mp4', '4.mp4'])
    ...
    return jsonify({"error": "not_found", "message": "About video files are missing on server"}), 404
