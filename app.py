...
def verify_role_code():
    ...
    role = None
    if code == ROLE_CODES['owner']:
        role = 'owner'
    elif code == ROLE_CODES['co_owner']:
        role = 'co_owner'
    elif code == ROLE_CODES['mod']:
        role = 'mod'
    elif code == ROLE_CODES['host']:
        role = 'host'
    ...
    if role:
        ...
        return jsonify({"success": False, "error": "Invalid code. You don't have access to this panel. Contact administration for help."})
